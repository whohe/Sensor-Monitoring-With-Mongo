...
def meteorological_seeder():
    ...
    for i in range(len(sintetical_pressure_data)):
        print('pressure: '+str(sintetical_pressure_data[i]))
        print('wind_speed: '+str(sintetical_wind_speed_data[i]))
        time.sleep(1)
...
def ambient_seeder():
    ...
    for i in range(len(sintetical_air_quality_data)):
        print('noise_level: '+str(sintetical_noise_level_data[i]))
        print('air_quality: '+str(sintetical_air_quality_data[i]))
        time.sleep(1)
...
def weather_seeder():
    ...
    for i in range(len(sintetical_humidity_data)):
        print('temperature: '+str(sintetical_temperature_data[i]))
        print('humidity: '+str(sintetical_humidity_data[i]))
        time.sleep(1)
